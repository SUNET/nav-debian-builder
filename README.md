...
<dl>
  ...
  <dt><code>build-from-git-source.sh</code></dt>
  <dd>Will run <code>debuild</code> inside a Docker container to produce a working Debian package based on a remote git-repository</dd>
